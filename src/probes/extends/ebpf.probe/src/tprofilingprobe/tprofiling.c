...
static syscall_meta_t g_syscall_metas[] = {
    // file
    {SYSCALL_READ_ID, SYSCALL_READ_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_WRITE_ID, SYSCALL_WRITE_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_READV_ID, SYSCALL_READV_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_WRITEV_ID, SYSCALL_WRITE_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_PREADV_ID, SYSCALL_PREADV_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_PWRITEV_ID, SYSCALL_PWRITEV_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_PREADV2_ID, SYSCALL_PREADV2_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_PWRITEV2_ID, SYSCALL_PWRITEV2_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_SYNC_ID, SYSCALL_SYNC_NAME, 0},
    {SYSCALL_FSYNC_ID, SYSCALL_FSYNC_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_FDATASYNC_ID, SYSCALL_FDATASYNC_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_SYNCFS_ID, SYSCALL_SYNCFS_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_MSYNC_ID, SYSCALL_MSYNC_NAME, 0},
    // process
    {SYSCALL_SCHED_YIELD_ID, SYSCALL_SCHED_YIELD_NAME, 0},
    {SYSCALL_PAUSE_ID, SYSCALL_PAUSE_NAME, 0},
    {SYSCALL_NANOSLEEP_ID, SYSCALL_NANOSLEEP_NAME, 0},
    {SYSCALL_CLOCK_NANOSLEEP_ID, SYSCALL_CLOCK_NANOSLEEP_NAME, 0},
    {SYSCALL_WAIT4_ID, SYSCALL_WAIT4_NAME, 0},
    {SYSCALL_WAITPID_ID, SYSCALL_WAITPID_NAME, 0},
    // network
    {SYSCALL_SENDTO_ID, SYSCALL_SENDTO_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_RECVFROM_ID, SYSCALL_RECVFROM_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_SENDMSG_ID, SYSCALL_SENDMSG_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_RECVMSG_ID, SYSCALL_RECVMSG_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_SENDMMSG_ID, SYSCALL_SENDMMSG_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_RECVMMSG_ID, SYSCALL_RECVMMSG_NAME, SYSCALL_FLAG_FD},
    {SYSCALL_SENDFILE_ID, SYSCALL_SENDFILE_NAME, 0},
    {SYSCALL_SELECT_ID, SYSCALL_SELECT_NAME, 0},
    {SYSCALL_PSELECT6_ID, SYSCALL_PSELECT6_NAME, 0},
    {SYSCALL_POLL_ID, SYSCALL_POLL_NAME, 0},
    {SYSCALL_PPOLL_ID, SYSCALL_PPOLL_NAME, 0},
    {SYSCALL_EPOLL_WAIT_ID, SYSCALL_EPOLL_WAIT_NAME, 0},
    {SYSCALL_EPOLL_CTL_ID, SYSCALL_EPOLL_CTL_NAME, 0},
    // IPC
    {SYSCALL_SEMOP_ID, SYSCALL_SEMOP_NAME, 0},
    {SYSCALL_MSGSND_ID, SYSCALL_MSGSND_NAME, 0},
    {SYSCALL_MSGRCV_ID, SYSCALL_MSGRCV_NAME, 0},
    {SYSCALL_RT_SIGTIMEDWAIT_ID, SYSCALL_RT_SIGTIMEDWAIT_NAME, 0},
    {SYSCALL_RT_SIGSUSPEND_ID, SYSCALL_RT_SIGSUSPEND_NAME, 0},
    {SYSCALL_FUTEX_ID, SYSCALL_FUTEX_NAME, SYSCALL_FLAG_STACK},
    {SYSCALL_MQ_TIMEDSEND_ID, SYSCALL_MQ_TIMEDSEND_NAME, 0},
    {SYSCALL_MQ_TIMEDRECEIVE_ID, SYSCALL_MQ_TIMEDRECEIVE_NAME, 0},
    // log
    {SYSCALL_SYSLOG_ID, SYSCALL_SYSLOG_NAME, 0}
};
...
static int init_syscall_table_map(int syscall_table_fd)
{
    ...
    for (int i = 0; i < sizeof(g_syscall_metas) / sizeof(syscall_meta_t); i++) {
        ...
        scm_ptr = (syscall_meta_t *)malloc(sizeof(syscall_meta_t));
        if (scm_ptr == NULL) {
            return -1;
        }
        memset(scm_ptr, 0, sizeof(syscall_meta_t));

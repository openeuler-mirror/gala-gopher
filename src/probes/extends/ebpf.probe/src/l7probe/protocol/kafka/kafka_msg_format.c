...
const int KAFKA_MIN_REQ_FRAME_LENGTH =
        KAFKA_PAYLOAD_LENGTH + KAFKA_API_KEY_LENGTH + KAFKA_API_VERSION_LENGTH + KAFKA_CORRELATION_ID_LENGTH;
const int KAFKA_MIN_RESP_FRAME_LENGTH = KAFKA_PAYLOAD_LENGTH + KAFKA_CORRELATION_ID_LENGTH;

...
ProbeType = IntEnum('ProbeType', ('PROBE_BASEINFO', 'PROBE_VIRT', 'PROBE_FG', 'PROBE_L7', 'PROBE_TCP',\
    'PROBE_SOCKET', 'PROBE_IO', 'PROBE_PROC', 'PROBE_JVM', 'PROBE_REDIS_SLI', 'PROBE_POSTGRE_SLI', \
    'PROBE_GAUSS_SLI', 'PROBE_DNSMASQ', 'PROBE_LVS ', 'PROBE_NGINX', 'PROBE_HAPROXY', 'PROBE_KAFKA', \
    'PROBE_TP', 'PROBE_HW', 'PROBE_KSLI', 'PROBE_SCHED ', 'PROBE_CONTAINER', 'PROBE_SERMANT', 'PROBE_TYPE_MAX'))

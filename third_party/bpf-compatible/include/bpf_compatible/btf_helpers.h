...
static __attribute__((unused)) int ensure_core_btf(struct bpf_object_open_opts* opts) {
    return ensure_core_btf_with_linked_tar(&opts->btf_custom_path);
}

static __attribute__((unused)) int ensure_core_btf_tar(struct bpf_object_open_opts* opts,
                               const char* tar_bin,
                               int tar_len) {
...
static __attribute__((unused)) void cleanup_core_btf(struct bpf_object_open_opts* opts) {
